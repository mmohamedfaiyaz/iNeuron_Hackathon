    ...
    triggerSupplierContractEventListeners() {
            ...
            if (err) {
                ...
                this.setState({
                    supplierContract_blockchainRecordedItemIds: [...this.state.supplierContract_blockchainRecordedItemIds,
                        Number(eventLogs.args.idItem.toString())
                    ]
                });
            }
        })
            ...
            if (err) {
                ...
                this.setState({
                    supplierContract_blockchainRecordedPurchaseOrderServices: [...this.state.supplierContract_blockchainRecordedPurchaseOrderServices,
                        {
                            'idOfCustomer': parseInt(eventLogs.args.idOfCustomer.toString(),10),
                            'idOrder': parseInt(eventLogs.args.idOrder.toString(),10),
        ...
        this.customerContract_orderRaisedEvents.watch((err, eventLogs) => {
            if (err) {
                ...
                console.log('[Event Logs]', eventLogs);
                if (this.state.customerContract_blockchainRecordedPurchaseOrderIds.indexOf(parseInt(eventLogs.args.idOrder.toString(),10))  === -1){
                    this.setState({
                                    ...
                                    <Tab eventKey={2} title="Process Order(s)">
                                        ...
                                        <Table striped bordered condensed hover>
                                            ...
                                            <tbody>
                                                ...
                                                const orderedItemQuantity = parseInt(String(orderDetails).split(',')[1],10);
